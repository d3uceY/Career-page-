...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == $defInst->getActions()["addTelentHunt"]){
	...
	$cover = isset($_FILES["tcover"]) ? $_FILES["tcover"] : "";
	die($careerInst->talentHuntpply($position, $emailAddress, $firstName, $lastName, $phoneNumber, $address, $skills, $notice, $salary, $resume, $cover, $edu, $experience));
     ...
     .column1w {
        ...
        <section class="elementor-section elementor-top-section elementor-element elementor-element-4c9d7fc elementor-section-boxed elementor-section-height-default elementor-section-height-default" style="background-color: rgb(230,230,230) !important;" data-id="4c9d7fc" data-element_type="section">
			...
			<div class="elementor-widget-wrap" style="background-color: rgb(230,230,230) !important;">
				...
				<h3 style="font-family: 'Montserrat'; font-size: 25px; color: #000000; font-weight: bolder;">Please provide us with a few details and hit the “Submit” button to join our our amazing talent pool.</h3>
				...
				<form id="applyForm">
						...
						<br>
                        <label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="position">Desired Position / Role&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<input type="text" name="position" id="position" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<br>
						...
						<br><br>
                        <label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="experience">How many  years of relevant experience do you have&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						...
						<br>
                        <label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="salary">Desired Salary&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<input type="text" name="salary" id="salary" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px;" />
						<br>
                        <label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="skills">Relevant Skills / Certifications&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<input name="skills" id="skills" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px;" />
						<br><br>
						...
						<input type="date" name="notice" id="notice" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px;" />
						<br>
						
						
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="tresume">Resume / CV&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<input type="file" name="tresume" id="tresume" style="display:none;" accept=".doc, .docx, .pdf, .txt, .rtf" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						...
						<br>
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="tcover">Cover Letter</label>
						<input type="file" id="tcover" name="tcover" style="display:none;" accept=".doc, .docx, .pdf, .txt, .rtf" style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						...
						<p style="font-weight: bold;"><span style="color: #000000 !important;">(File types: pdf, doc, docx, rtf)</p>
						<br>
						<input name="action"  type="hidden" value="35" id="action" required/>
...
function open_cover() {
			$("#tcover").trigger('click');
        }

		function open_resume() {
			$("#tresume").trigger('click');
        }
