...
$careerInst = new CareerManager();
$defInst = new defaults();
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == $defInst->getActions()["addapply"]){
	...
	die($careerInst->jobApply($jobID, $emailAddress, $firstName, $lastName, $phoneNumber, $address, $industry, $reference, $notice, $salary, $resume, $cover, $edu, $experience, $jLocation));
...
else
{
	...
	$jList = $dbInst->execute_return("SELECT * FROM `job-opening` WHERE id='$jobID'")[0];
	$datetime1 = date_create(date('Y-m-d')); 
	$daysLeft = "NONE";
	if($jList['duration'] !== null && $jList['duration'] !== ""){
		$daysLeft = date('l jS \of F Y ', strtotime($jList['duration'])); 
							
							// Calculates the difference between DateTime objects 
							//$interval = date_diff($datetime1, $datetime2);

							//$daysLeft = $interval->format('%a days Left');
	}
							
	$subID = $jList['sub-id'];
	$locID =$jList['loc-id'];
	$subsidiary = $dbInst->execute_return("SELECT `sub-name` FROM `sub-table` WHERE id = '$subID'")[0]["sub-name"];

	$subsidiary = $dbInst->execute_return("SELECT `sub-name` FROM `sub-table` WHERE id = '$subID'")[0]["sub-name"];
	$iconExt = $dbInst->execute_return("SELECT `icon` FROM `sub-table` WHERE id = '$subID'")[0]["icon"];
	$location = $dbInst->execute_return("SELECT `location-state`, `location-country` FROM `location-table` WHERE id = '$locID'")[0];
}
...
$optionList = "<option value=''>Select Preferred Location</option>";
...
<li id="menu-item-10372" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-10372 mega-menu dropdown_menu"><a href="https://danagroup.com/career-opportunities/#"> Our Subsidiaries </a><ul style="display: block;"><li><div class="dl-mm-container dl-mm-col-6"><div class="dl-mm-item dl-list-item no-title"><ul style="display: block;"><li><a href="http://localhost:8888/Dana-Group/dana-air/"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg> Dana Air</a></li></ul></div><div class="dl-mm-item dl-list-item no-title"><ul style="display: block;"><li><a href="http://localhost:8888/Dana-Group/KIA-NIGERIA/"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg> Kia Nigeria</a></li></ul></div><div class="dl-mm-item dl-list-item no-title"><ul style="display: block;"><li><a href="http://localhost:8888/Dana-Group/dana-plast/"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg> Dana Plastics</a></li></ul></div><div class="dl-mm-item dl-list-item no-title"><ul style="display: block;"><li><a href="http://localhost:8888/Dana-Group/DANA-PHARMA/"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg> Dana Pharma</a></li></ul></div><div class="dl-mm-item dl-list-item no-title"><ul style="display: block;"><li><a href="http://localhost:8888/Dana-Group/dfm-nigeria/"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg> DFM Nigeria</a></li></ul></div><div class="dl-mm-item dl-list-item no-title"><ul style="display: block;"><li><a href="http://localhost:8888/Dana-Group/dlc-africa/"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path></svg> DLC Africa</a></li></ul></div></div></li></ul><span class="dropdown-plus dl dl-chevron-down"></span></li>
...
<style>
     .column1w {
        ...
        <section class="elementor-section elementor-top-section elementor-element elementor-element-4c9d7fc elementor-section-boxed elementor-section-height-default elementor-section-height-default" style="background-color: rgb(230,230,230) !important;" data-id="4c9d7fc" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default" style="background-color: rgb(230,230,230) !important;">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-81b9da4" style="background-color: rgb(230,230,230) !important;" data-id="81b9da4" data-element_type="column">
			<div class="elementor-widget-wrap" style="background-color: rgb(230,230,230) !important;">
                
                
                <div style="width: 90%; border-top-left-radius: 10px;  border-top-right-radius:10px; background-color: #FFFFFF !important; height: 200px; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: 0px;">
                    <div>
                        
                        <div class="column1w">
                        <h2 style="font-weight:bold; color: #0C247E; font-family: 'Montserrat';"><?php echo $jList["title"];?></h2>
    
                        </div>

                        <div class="column2w">

                        <button type="button" onclick="scrollApply();" style="background-color: #EE2326; border-radius: 5px; padding-left: 20px; padding-right: 20px; margin: auto; font-family: 'Montserrat' !important;">Apply</button>
                    ...
                    <div>
                            ...
                            <div class="column3w">
                                <div class="column1w" style="width: 20% !important; padding: 0px !important; margin: 0px !important;">
                                    
								<img src="<?php echo $iconExt == "" || $iconExt == null ? 'WebApp/Career/s1.png' : 'WebApp/File_Uploads/subsidiary/'.$subID.'.'.$iconExt ?>" width="40px" height="40px" />
                                </div>
                                <div class="column1w" style="width: 80% !important; padding: 0px !important; margin: 0px !important;">
                                    
                                <h5 style="font-weight:bold; color: #000000; font-family: 'Montserrat';"><?php echo $subsidiary; ?></h5>
                                <p>Company</p>
                                </div>
                            ...
                            <div class="column3w">
                                <div class="column1w" style="width: 20% !important; padding: 0px !important; margin: 0px !important;">
                                    <img src="WebApp/Career/s2.png" width="40px" height="40px" />
                                </div>
                                <div class="column1w" style="width: 80% !important; padding: 0px !important; margin: 0px !important;">
                                    
                                <h5 style="font-weight:bold; color: #000000; font-family: 'Montserrat';"><?php echo $location["location-state"].", ".$location["location-country"]; ?></h5>
                                <p>Location</p>
                                </div>
                            ...
                            <div class="column3w">
                                <div class="column1w" style="width: 20% !important; padding: 0px !important; margin: 0px !important;">
                                    <img src="WebApp/Career/s3.png" width="40px" height="40px" />
                                </div>
                                <div class="column1w" style="width: 80% !important; padding: 0px !important; margin: 0px !important;">
                                    
                                <h5 style="font-weight:bold; color: #000000; font-family: 'Montserrat';">Full Time - On-site</h5>
                                <p>Work-Term</p>
                                </div>
                ...
                <div style="width: 90%; background-color: #FFFFFF !important; margin-left: auto; margin-right: auto; margin-top: 0px;">
                


				<div style="padding: 20px; background-color: #FFFFFF;">

                <h5 style="font-weight:bolder !important; color: rgb(238,35,38); font-family: 'Montserrat';">Application Deadline: <?php echo $daysLeft; ?></h5>
                </div>


                <div style="padding: 20px; background-color: #FFFFFF;">

                <h6 style="font-weight:bolder !important; color: #0C247E; font-family: 'Montserrat';">Job Summary</h6>
                </div>

                <div style="padding-left: 20px; padding-right: 20px; background-color: #FFFFFF;">

                <p style="font-weight:bold; color: #000000; font-family: 'Montserrat'; text-align: justify;"><?php echo $jList["job-desc"]; ?></p>
                </div>
                ...
                <h6 style="font-weight:bolder !important; color: #0C247E; font-family: 'Montserrat';">Responsibilities:</h6>
                </div>

                <div style="padding-left: 20px; padding-right: 20px; background-color: #FFFFFF;">

                <p style="font-weight:bold; color: #000000; font-family: 'Montserrat'; text-align: justify;"><?php echo $jList["job-resp"]; ?></p>
                </div>
                ...
                <h6 style="font-weight:bolder !important; color: #0C247E; font-family: 'Montserrat';">Required Skills / Experience:</h6>
                </div>

                <div style="padding-left: 20px; padding-right: 20px; background-color: #FFFFFF;">

                <p style="font-weight:bold; color: #000000; font-family: 'Montserrat'; text-align: justify;"><?php echo $jList["job-req"]; ?></p>
                </div>
				...
				<!-- Application Form -->
				<div style="border-bottom-left-radius: 10px;  border-bottom-right-radius:10px; width: 90%; background-color: #FFFFFF !important; margin-left: auto; margin-right: auto; margin-top: 0px; margin-bottom: 30px;">
                
				<a id="applyFormSection"></a>
				<div style="background-color: #FFFFFF; padding: 20px;">
				<!-- Load From UI -->
				
				<h3 style="font-family: 'Montserrat'; font-size: 25px; color: #000000; font-weight: bolder;">Apply for this job</h3>
				<p style="font-weight: bold;"><span style="color: #FF0000 !important;">*</span>&nbsp;&nbsp;Required</p>
				<hr style="background-color: #E8CACB; height: 3px;"/>
				</div>
				...
				<form id="applyForm">
						...
						<input type="text" name="firstName" id="firstName" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<br>
						...
						<input type="text" name="lastName" id="lastName" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<br>
						...
						<input type="email" name="emailAddress" id="emailAddress" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<br>
						...
						<input type="text" name="phoneNumber" id="phoneNumber" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<br>
						...
						<input type="text" name="address" id="address" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<br>
							<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="edu">Educational Qualification&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<select type="text" name="edu" id="edu" required style="background-color: #E8CACB; height: 40px; width: 100%;  border: none !important; border-radius: 15px; color: #000000; font-weight: bold;">
						<?php
						$indList = $dbInst->execute_return("SELECT * FROM `edu-table` WHERE 1 ORDER BY id DESC");
						if(isset($indList) && is_array($indList))
						{
							foreach($indList as $key=>$value)
							{
								if($key == 0){
								    echo "<option value='' selected>Select Educational Qualification</option>";

									echo "<option value='".$value["id"]."'>".$value["edu-name"]."</option>";
								}
								else{
									echo "<option value='".$value["id"]."'>".$value["edu-name"]."</option>";
								}
							...
							echo "<option value='' selected>No educatinal qualification available</option>";
						}
						...
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="industry">Previous Industry Experience&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<select type="text" name="industry[]" id="industry" multiple required style="background-color: #E8CACB; height: 150px; width: 100%;  border: none !important; border-radius: 15px; padding: 10px; color: #000000; font-weight: bold;">
						<?php
						$indList = $dbInst->execute_return("SELECT * FROM `ind-table` WHERE 1 ORDER BY id DESC");
						if(isset($indList) && is_array($indList))
						{
							foreach($indList as $key=>$value)
							{
								if($key == 0){
									...
									echo "<option value='".$value["id"]."' selected>".$value["ind-name"]."</option>";
								}
								else{
									echo "<option value='".$value["id"]."'>".$value["ind-name"]."</option>";
								}
							}
						}
						else{
							echo "<option value='' selected>No industry category available</option>";
						}
						...
						<select type="text" name="reference" id="reference" required style="background-color: #E8CACB; height: 40px; width: 100%; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;">
						<?php
						$refList = $dbInst->execute_return("SELECT * FROM `ref-table` WHERE 1 ORDER BY id DESC");
						if(isset($refList) && is_array($indList))
						{
							foreach($refList as $key=>$value)
							{
								if($key == 0){
                                    echo "<option value='' selected>Select Reference</option>";
									echo "<option value='".$value["id"]."'>".$value["ref-name"]."</option>";
								}
								else{
									echo "<option value='".$value["id"]."'>".$value["ref-name"]."</option>";
								}
							...
							echo "<option value='' selected>No reference available</option>";
						}
						
						?>
						</select>
						<br><br>
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="jLocation">Preferred Job Location&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<select  name="jLocation" id="jLocation" required style="background-color: #E8CACB; height: 40px; width: 100%; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;">
						<?php echo $optionList; ?>
						</select>
						<br><br>
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="notice">How long is your notice period (days)&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<select type="text" name="notice" id="notice" required style="background-color: #E8CACB; height: 40px; width: 100%; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;">
						...
						<input type="number" name="experience" id="experience" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
	
						<br>
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="salary">Please indicate your salary expectation in NGN (per annum)</label>
						<input type="text" name="salary" id="salary" style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px;" />
						<br>
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="resume">Resume / CV&nbsp;&nbsp;<span style="color: #FF0000 !important;">*</span></label>
						<input type="file" name="resume" id="resume" style="display:none;" accept=".doc, .docx, .pdf, .txt, .rtf" required style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<button onclick="open_resume();" type="button" style="background-color: #0B237D; padding: 15px; padding-left: 25px; padding-right: 25px; border-radius: 5px;">Upload</button>
						<p style="font-weight: bold;"><span style="color: #000000 !important;">(File types: pdf, doc, docx, rtf)</p>
						<br>
						<label style="font-weight: bold; text-transform: capitalize; margin-bottom: 5px;" for="cover">Cover Letter</label>
						<input type="file" id="cover" name="cover" style="display:none;" accept=".doc, .docx, .pdf, .txt, .rtf" style="background-color: #E8CACB; height: 40px; border: none !important; border-radius: 15px; color: #000000; font-weight: bold;" />
						<button onclick="open_cover();" type="button" style="background-color: #0B237D; padding: 15px; padding-left: 25px; padding-right: 25px; border-radius: 5px;">Upload</button>
						<p style="font-weight: bold;"><span style="color: #000000 !important;">(File types: pdf, doc, docx, rtf)</p>
						<br>
						<input name="action"  type="hidden" value="30" id="action" required/>
						<input name="jobID"  type="hidden" value="<?php echo $_SESSION['jobID']; ?>" id="action" required/>
						<div style="width: 100%; justify-content: center; align-items: center; text-align: center;">
						<button type="submit" style="background-color: #EE2326; border-radius: 5px; padding-left: 20px; padding-right: 20px; margin: auto; font-family: 'Montserrat' !important; margin: auto;"><span class="appSubmit">Submit</span><span class="loaderCont"><i class="fa fa-spinner fa-spin"></i>&nbsp;&nbsp;Loading</span></button>
						</div>
						</div>
...
<div class="cf7-btn">
	<p><input class="wpcf7-form-control wpcf7-submit has-spinner" type="submit" value="Get In Touch"><span class="wpcf7-spinner"></span>
			...
			<div class="section-heading">
															<p>© Copyright <?php echo date('Y'); ?> Dana Group </p><p>All Rights Reserved</p>
							</div>
		</div>
...
function scrollApply(){
	...
	$('html, body').animate({
            scrollTop: $('#applyFormSection').offset().top
    }, 'slow');
}
...
function applyJob(){
    ...
    //var locationPostData = $('#applyForm').serializeArray();
											$.ajax({ 
                                                type:"POST",
                                                url:"job-apply",
                                                data: formData,
